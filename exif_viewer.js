...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            this.addWidget("text","positive","",(v)=>{},{});
            this.addWidget("text","negative","",(v)=>{},{});
            this.widgets[this.widgets.length-2].hidden = true;
            this.widgets[this.widgets.length-1].hidden = true;
        };
